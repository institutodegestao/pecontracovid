...
int_pac <- read.csv2('../saude/regulador/painel/internamento_paciente.csv', sep = ';') # carga
...
### base 2 = solicitacoes
sol_pac <- read.csv2('../saude/regulador/painel/solicitacao.csv', sep = ';') # carga
...
### base 3 = leitos
leito <- read.csv2('../saude/regulador/painel/leitos.csv', sep = ';') # carga
...
leito <- leito %>% filter(unidade != 2395 & unidade != 2845 & unidade != 2847 & unidade != 2932 & unidade != 3901 & unidade != 5876 & unidade != 6334 & unidade != 6748)
...
########
int_total <- read.csv2('../saude/regulador/painel/internamento_total.csv', sep = ';')

### base 5 = historico_solicitacoes

sol_hist_nova <- read.csv2('../saude/regulador/painel/historico_solicitacao_nova.csv', sep = ';') 
...
###################### LEITOS PRIVADOS ##########################
leitos_privados_load <- read.csv2('../saude/regulador/painel/leitos_privados.csv', sep = ';', encoding = "UTF-8")
